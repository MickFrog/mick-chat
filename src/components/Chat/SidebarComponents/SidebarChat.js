...
const SidebarChat = () => {
    ...
    return (
        <div className="rounded bg-blue-400 dark:bg-slate-800 hover:bg-blue-500 dark:hover:bg-gray-600 ease-in-out duration-200 flex items-center gap-1 px-1 py-2 border-b 
